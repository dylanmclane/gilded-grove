        ...
        <div className={`w-full max-w-6xl rounded-3xl shadow-xl p-8 border flex flex-col min-h-[80vh] ${darkMode ? "bg-[#23272f] border-[#35373b]" : "bg-[#fcfcfd] border-[#ececec]"}`} style={{ boxShadow: '0 8px 32px 0 rgba(0,0,0,0.08)' }}>
          ...
          <div className="mb-8">
            ...
            <div className="block lg:hidden space-y-4">
              {assets.map(asset => (
                <div key={asset.id} className={`rounded-2xl shadow-sm border p-5 ${darkMode ? 'border-[#35373b] bg-[#23272f]' : 'border-[#ececec] bg-[#fafafd]'}`}>
                  <div className={`font-semibold text-lg mb-3 ${darkMode ? 'text-[#f7f8fa]' : 'text-gray-900'}`}>{asset.name}</div>
            ...
            <div className={`hidden lg:block overflow-x-auto rounded-2xl shadow-sm border ${darkMode ? 'border-[#35373b] bg-[#23272f]' : 'border-[#ececec] bg-[#fafafd]'}`}>
